...
def ai_chat(data: AIChatMessage, db=Depends(get_db)):
    ...
    simple one like x^2 - always use LaTeX notation: $...$ for inline math (e.g.
    $x^2 + y^2 = z^2$) and $$...$$ for standalone/display equations. Never write
    math in plain text or with ASCII symbols like ^ or sqrt() outside of LaTeX.
    {datetime_block}
    {search_block}
...
def ai_chat_vision(data: AIVisionChatSchema, db=Depends(get_db)):
    ...
    use LaTeX notation: $...$ for inline math and $$...$$ for display equations.
