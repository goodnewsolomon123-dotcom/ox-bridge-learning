...
def get_ai_response(prompt: str) -> str:
    ...
    # 7. HuggingFace (FIXED: old api-inference.huggingface.co endpoint was
    # fully retired - HTTP 410 Gone - replaced by router.huggingface.co,
    # which uses OpenAI-style chat completions instead of the old raw
